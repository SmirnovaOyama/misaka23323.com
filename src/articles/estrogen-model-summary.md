> 此文章为网站 https://hrt.misaka23323.com 底层医学模型的具体解释。
> 更新时间：2025 年 12 月 5 日
## 目录
...
A(\tau)
= D F k_1 k_2 \left[
\frac{e^{-k_1 \tau}}{(k_1 - k_2)(k_1 - k_3)}

* \frac{e^{-k_2 \tau}}{(k_2 - k_1)(k_2 - k_3)}
* \frac{e^{-k_3 \tau}}{(k_3 - k_1)(k_3 - k_2)}
  \right],
  \quad \tau \ge 0
  $$
